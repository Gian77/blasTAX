...
show_help() {
  ...
  echo "  -d, --database       Specify the database path (default: /mnt/research/glbrc_group/benuccigmn/DATABASES/NCBI_core_nt/core_nt)"
...
db="/mnt/research/glbrc_group/benuccigmn/DATABASES/NCBI_core_nt"
threads=16
max_hits=25
confidence=0.7
ethresh=0.001
...
bash code/blast.sh ${out_dir}/parsed_input.fasta $db/core_nt $threads $max_hits $out_dir
